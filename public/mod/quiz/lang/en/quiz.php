...
$string['overdueattemptsmaxqueueperrun'] = 'Maximum overdue attempts queued per run';
$string['overdueattemptsmaxqueueperrun_desc'] = 'The maximum number of overdue attempts queued in each run of queue_overdue_attempt_updates. Increase this if overdue attempts are not being queued quickly enough and your cron/adhoc workers have spare capacity. Decrease this if queueing causes bursts in the adhoc queue, especially when this task runs concurrently on multiple cron workers or nodes.';
...
$string['queueoverdueattemptupdatestask'] = 'Queue overdue quiz attempt updates';
...
$string['updateoverdueattempttask'] = 'Update overdue quiz attempt';

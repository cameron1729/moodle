...
$string['overdueattemptsmaxqueueperrun_desc'] = 'The maximum number of overdue attempts that are queued for asynchronous processing in each run of the scheduled task. Set this based on your cron capacity and expected quiz concurrency.';

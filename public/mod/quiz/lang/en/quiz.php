...
$string['overdueattemptsmaxruntime'] = 'Maximum runtime for overdue attempt queueing';
$string['overdueattemptsmaxruntime_desc'] = 'The maximum time each run of update_overdue_attempts should spend queueing overdue attempt adhoc tasks. Set to 0 to queue all eligible attempts in one run. Decrease this if you run multiple cron workers/nodes and want shorter, more predictable queueing runs.';
...
$string['updateoverdueattemptstask'] = 'Queue overdue quiz attempt updates';

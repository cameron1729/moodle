...
EOD;
    ...
    public function test_upsert_record(): void {
        ...
        try {
            ...
            $this->assertSame(
                'Coding error detected, it must be fixed by a programmer: moodle_database::upsert_record() '
                . 'dataobject must have all unique columns set, missing mnethostid,username',
                $ex->getMessage()
            );
        }
        ...
        try {
            ...
            $this->assertSame(
                'Coding error detected, it must be fixed by a programmer: moodle_database::upsert_record() '
                . 'dataobject must have all unique columns set, missing name',
                $ex->getMessage()
            );
        }
        ...
        try {
            ...
            $this->assertSame(
                'Coding error detected, it must be fixed by a programmer: moodle_database::upsert_record() '
                . 'dataobject must not have id property',
                $ex->getMessage()
            );
        }
        ...
        try {
            ...
            $this->assertSame(
                'Coding error detected, it must be fixed by a programmer: moodle_database::upsert_record() '
                . 'dataobject contains unknown column \'xyz\'',
                $ex->getMessage()
            );
        }
        ...
        try {
            ...
            $this->assertSame(
                'Coding error detected, it must be fixed by a programmer: moodle_database::upsert_record() '
                . 'insertonlyfields must not share column \'value\' with dataobject',
                $ex->getMessage()
            );
        }
        ...
        try {
            ...
            $this->assertSame(
                'Coding error detected, it must be fixed by a programmer: moodle_database::upsert_record() '
                . 'insertonlyfields contains \'name\'=>different but is different to the data object \'name\'->something',
                $ex->getMessage()
            );
        }
    }
